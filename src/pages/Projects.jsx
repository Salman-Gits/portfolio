...
export default function Projects() {
  ...
  const projects = [
    {
      id: '01', title: 'Blood Bank Hub', subtitle: 'Healthcare Platform', version: 'v1.2.0',
      ...
      metrics: '8+ API Endpoints', category: 'infrastructure',
      liveUrl: 'https://blood-bank-rouge-alpha.vercel.app/', repoUrl: 'https://github.com/Salman-Gits'
    },
    {
      id: '02', title: 'Nexus E-Commerce', subtitle: 'Shopping Platform', version: 'v2.0.1',
      ...
      metrics: 'Real-time Sync', category: 'transactional',
      liveUrl: 'https://ecommerce-frontend-seven-sooty.vercel.app/', repoUrl: 'https://github.com/Salman-Gits'
    },
    {
      id: '03', title: 'Rental Lease Engine', subtitle: 'Logistics & Automation', version: 'v1.0.4',
      ...
      metrics: 'Dynamic Tracking', category: 'logistics',
      liveUrl: 'https://rental-opal-one.vercel.app/', repoUrl: 'https://github.com/Salman-Gits'
    },
    {
      id: '04', title: 'Creative Showcase', subtitle: 'Portfolio & Motion Design', version: 'v1.1.0',
      ...
      metrics: 'Smooth Transitions', category: 'design',
      liveUrl: 'https://shaheinsha-portfolio.vercel.app/', repoUrl: 'https://github.com/Salman-Gits'
    },
    {
      id: '05', title: 'KG Badminton', subtitle: 'Client Project', version: 'v1.0.0',
      ...
      metrics: 'Production Ready', category: 'design',
      liveUrl: 'https://kgbadminton.vercel.app/', repoUrl: 'https://github.com/Salman-Gits'
    }
  ]
  ...
  return (
    <div className="page-fade-in projects-page container">
      <header className="page-header">
        ...
        >Live Projects & Systems</motion.span>
        <motion.h1
      ...
      <motion.div layout className="projects-catalog-grid grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
        <AnimatePresence mode="popLayout">
          {filteredProjects.map((project) => (
            ...
            >
              <TiltCard className="project-detail-card glass-card shimmer-card">
                <div>
                  <div className="flex justify-between items-center mb-5 pb-4" style={{ borderBottom: '1px solid var(--color-border)' }}>
